...
1. Open Obsidian
2. Create a new file: `reusable_side_panels.md`
3. Paste the full contents above into it
4. Embed into other notes using:
   ```md
   ![[reusable_side_panels#ExploitContext Overview]]
```

Or copy/paste the relevant panel directly.

---

Let me know if you want the GitBook conversion tool next.